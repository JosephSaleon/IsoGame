...
public class EnemyAttack : MonoBehaviour {
    ...
    [Header("Setting")]
    public float rangAttackDistance = 10f;
    ...
    private EnemyMouvement selfEnemyMouvementScript;
    ...
    public void Start()
    {
        ...
        selfEnemyMouvementScript = GetComponent<EnemyMouvement>();
        readyToAttack = true;
    ...
    void Update()
    {
        ...
        if(readyToAttack && distanceToPlayer < rangAttackDistance){
            readyToAttack = false;
    ...
    IEnumerator StartShootPhase(Vector3 fixDir){
        if(selfEnemyMouvementScript != null){
            selfEnemyMouvementScript.StopMoving();
        }
        for(int i = 0; i < attackPhase; i++){
            ...
            if(i == (attackPhase - 1)){
                ...
                if(selfEnemyMouvementScript != null){
                    selfEnemyMouvementScript.StartMoving();
                }
            }                
        }
    }
    ...
    private void shoot(Vector3 dir){
        ...
        projectilInstance.GetComponent<EnemyProjectil>().lifeTime = ProjectilLifeTime;
