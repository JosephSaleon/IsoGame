...
public class DmgPopUp : MonoBehaviour
{
    ...
    public static DmgPopUp Create(Vector3 position, int dmgAmount, bool isCritical, string type = null){
        ...
        dmgPopUp.Setup(dmgAmount, isCritical, type);
    ...
    public void Setup(int dmgAmount, bool isCritical, string type ){
        ...
        if(type == "dead"){ 
            textMesh.color = new Color32(255, 128, 0, 255);
        }
